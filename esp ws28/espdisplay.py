...
class Display:
    def __init__(self, cols, rows, pixel_width=40,baudrate=2000000,connection_type='serial'):
        ...
        self.esp_ip = '192.168.43.169'  # Replace with your ESP8266's IP address
        self.esp_port = 8266  # Replace with the port number your ESP is listening on
...
def main():
    ...
    g = 20
    b = 0
    game_display.fill((r%100, g%100, b%100))

    while running:
        #game_display.fill((25, 20, 12))
        game_display.fill((r%40, g%40, b%40))
        ...
        game_display.put(32-(r%250)//15,1,((255-(r%205), g%205, b%25)))
        game_display.put(32-(r%250)//15,2,((255-(r%205), g%205, b%25)))
        game_display.put(32-(r%250)//15,16,((255-(r%205), g%205, b%25)))
